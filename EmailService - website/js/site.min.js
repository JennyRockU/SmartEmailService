async function SendEmail(recipient,sender,title,body){const url=getApiUrl(recipient,sender,title);try{var res=await fetch(url,{method:"post",body:body});console.log(res.statusText);return res}catch(exception){console.log('failed to send email')}}
